...
<section class="chambres">
        <div class="container1">
            <div class="section-header">
                <h2 class="section-title">Appartement F3</h2>
            ...
            <div class="chambre-card">
                <div class="chambre-gallery">
                    <div class="main-image">
                        <img src="img/a4.jpg" alt="Studio Appart Hôtel xxxx Oran" class="featured-image">
                    </div>
                    <div class="thumbnail-grid">
                        <div class="thumbnail" style="background-image: url('img/o.jpg')"></div>
                        <div class="thumbnail" style="background-image: url('img/a4.jpg')"></div>
                        <div class="thumbnail" style="background-image: url('img/a2.jpg')"></div>
                        <div class="thumbnail" style="background-image: url('img/c3.jpg')"></div>
                        <div class="thumbnail" style="background-image: url('img/f29.jpg')"></div>
                        <div class="thumbnail" style="background-image: url('img/f26.jpg')"></div>
                        <div class="thumbnail" style="background-image: url('img/f25.jpg')"></div>
                ...
                <div class="chambre-content">
                <h3 class="chambre-title">Un cadre luxueux et confortable</h3>
                <p>Profitez d’un espace de 100 m² conçu pour offrir un maximum de confort et d’élégance pour six personnes.</p>
               
                <section class="description">
                    <p>Ce vaste appartement comprend trois chambres séparées, un salon chaleureux et une cuisine moderne entièrement équipée.</p>
                    <p>Chaque chambre est meublée avec une literie premium garantissant un sommeil réparateur.</p>
                    <p>Le balcon privé offre une vue imprenable, idéale pour se détendre après une journée bien remplie.</p>
                </section>
                
                <section class="features">
                    <h2>Caractéristiques principales</h2>
                    <ul>
                        <li><strong>Superficie :</strong> 100 m², parfait pour 6 personnes.</li>
                        <li><strong>Trois chambres spacieuses :</strong> Une chambre avec lit king-size, deux autres avec lits jumeaux.</li>
                        <li><strong>Salon élégant :</strong> Canapé haut de gamme et télévision connectée.</li>
                        <li><strong>Cuisine équipée :</strong> Réfrigérateur, plaques de cuisson, four, micro-ondes et machine à café.</li>
                        <li><strong>Deux salles de bain modernes :</strong> Douches à l’italienne et articles de toilette premium.</li>
                        <li><strong>Balcon privé :</strong> Vue panoramique et coin détente.</li>
                        <li><strong>Wi-Fi ultra-rapide :</strong> Parfait pour le télétravail ou le divertissement.</li>
                        <li><strong>Climatisation et chauffage :</strong> Un confort optimal toute l’année.</li>
                    </ul>
                    
                    <h3>✨ Services inclus :</h3>
                    <ul>
                        <li>Petit-déjeuner offert</li>
                        <li>Accès au spa et salle de sport</li>
