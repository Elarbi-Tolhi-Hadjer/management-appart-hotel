...
<div class="photo-gallery">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Appart Hôtel xxxx Gallery</h2>
                <p class="text-center">Toutes les images ont été capturées à l'intérieur de notre Appart Hôtel xxxx.</p>            </div>
