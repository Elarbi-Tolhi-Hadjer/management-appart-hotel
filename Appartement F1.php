...
<section class="chambres">
        <div class="container1">
            <div class="section-header">
                <h2 class="section-title">Appartement F1 </h2>
            ...
            <div class="chambre-card">
               <div class="chambre-card">
                ...
                <h3 class="chambre-title">Un espace intime et élégant</h3>
                <p>Profitez d’un appartement moderne et lumineux, idéal pour deux personnes, avec une chambre élégante et un salon accueillant.</p>
               
                <section class="description">
                    <p>Ce charmant appartement de 50 m² vous offre tout le confort dont vous avez besoin avec un design raffiné et des équipements modernes.</p>
                    <p>La chambre est équipée d’un lit king-size avec une literie de qualité supérieure pour un sommeil paisible.</p>
                    <p>Un balcon privé vous permet de savourer un café le matin tout en admirant la vue environnante.</p>
                </section>
                
                <section class="features">
                    <h2>Caractéristiques principales</h2>
                    <ul>
                        <li><strong>Superficie :</strong> 50 m², parfait pour 2 personnes.</li>
                        <li><strong>Chambre élégante :</strong> Lit king-size et draps en coton premium.</li>
                        <li><strong>Salon confortable :</strong> Canapé moelleux et télévision à écran plat.</li>
                        <li><strong>Cuisine équipée :</strong> Réfrigérateur, plaques de cuisson, micro-ondes et cafetière.</li>
                        <li><strong>Salle de bain moderne :</strong> Douche à l’italienne et articles de toilette haut de gamme.</li>
                        <li><strong>Balcon privé :</strong> Vue agréable et espace détente.</li>
                        <li><strong>Wi-Fi rapide :</strong> Pour rester connecté sans souci.</li>
                        <li><strong>Climatisation et chauffage :</strong> Confort optimal toute l’année.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Conciergerie et service en chambre</li>
                    ...
                    <div class="booking-info">
                        ...
                        <a class="cta-button" href="client/room.php">Réserver maintenant</a>
