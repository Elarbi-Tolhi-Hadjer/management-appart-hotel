...
<section class="chambres">
        <div class="container1">
            <div class="section-header">
                <h2 class="section-title">Studio Moderne</h2>
            ...
            <div class="chambre-card">
                ...
                <div class="chambre-content">
                    ...
                    <p>Notre studio vous offre tout le confort nécessaire pour un séjour relaxant : un espace lumineux, un mobilier contemporain et des équipements modernes.</p>
                   <h4> Studio Standard (25 m² pour 2 personnes)</h4>
                   <p>Cet appartement cosy et fonctionnel de 25 m² est idéal pour les voyageurs en quête de simplicité et de confort.
                     Il dispose d'une kitchenette entièrement équipée, permettant de préparer des repas légers à tout moment de la journée
                     . La salle de bains privative garantit votre intimité et votre confort, tandis que le balcon ou la terrasse vous offre un espace extérieur où vous pourrez profiter d'une belle vue sur la ville. 
                     Parfait pour un couple ou une personne seule, le Studio Standard combine praticité et bien-être.</p>               
                <section class="features">
                    <h2>Caractéristiques principales</h2>
                    <ul>
                        <li><strong>Superficie :</strong> 25 m², idéal pour 2 personnes.</li>
                        <li><strong>Espace nuit :</strong> Lit double avec literie haut de gamme.</li>
                        <li><strong>Coin salon :</strong> Fauteuil élégant et télévision connectée.</li>
                        <li><strong>Kitchenette équipée :</strong> Réfrigérateur, plaques de cuisson, micro-ondes, cafetière et vaisselle.</li>
                        <li><strong>Salle de bain moderne :</strong> Douche à l’italienne, serviettes moelleuses et articles de toilette.</li>
                        <li><strong>Wi-Fi ultra-rapide :</strong> Parfait pour le travail et le streaming.</li>
                        <li><strong>Climatisation et chauffage :</strong> Confort assuré en toute saison.</li>
                    </ul>
                    
                    <h3>✨ Services inclus :</h3>
                    <ul>
                        <li>Petit-déjeuner en option</li>
                        <li>Ménage quotidien pour un séjour sans souci</li>
                        <li>Accès à la salle de sport et aux espaces de détente</li>
