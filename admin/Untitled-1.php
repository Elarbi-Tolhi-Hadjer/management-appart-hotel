    ...
    if($noOfUsers>=1){
        while($row=mysqli_fetch_assoc($allUser))
        {
          ...
          $userTable.=' <tr>
                    ...
                    <img class="round-img" src="../assets/picture/profiles/'.$row["ProfileImage"].'" alt="Profil"/>
                    </a>
                    </td>
                    <td>'.$row["FirstName"].'</td>
                    <td>'.$row["LastName"].'</td>
              ...
              $userTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous vraiment supprimer ".$row["FirstName"]."') && deleteUser('".$row["UserId"]."')\">Supprimer</button>
...
$returnData.='<div class="col-12 alert alert-danger">' . $_POST["error"] . '</div>';
  ...
  foreach($images as $image) {
    $returnData.=' <div class="col-sm-6 col-md-4 col-lg-3 item">
              ...
              <div class="overlay">';
              $returnData.="    <a class='info' href='#'  onclick=\"confirm('Voulez-vous vraiment supprimer cette image') && deleteImage('".$image."')\">Supprimer</a>
              </div>
              </div>
          </div>";
    ...
    if($noOfType>=1){
        while($row=mysqli_fetch_assoc($allType))
        {
          ...
          $typeTable.=' <tr>
                    ...
                    <img class="round-img" src="../assets/picture/RoomType/'.$row["RoomImage"].'" alt="Profil"/>
                    </a>
                    </td>
                    <td>'.$row["RoomType"].'</td>
                    <td>'.$row["Cost"].'</td>
              ...
              $typeTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous vraiment supprimer ".$row["RoomType"]."') && deleteRoomType('".$row["RoomTypeId"]."')\">Supprimer</button>
  ...
  <tbody>';
   ...
   if($roomFilter==""){
    ...
    if($noOfrooms>=1){
        while($row=mysqli_fetch_assoc($allRoom))
        {
          ...
          $roomTable.=' <tr>
              ...
              $roomTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous vraiment supprimer la chambre numéro ".$row["RoomNumber"]."') && deleteRoom('".$row["RoomId"]."')\">Supprimer</button>
    ...
    else 
    {
      ...
      $roomTable.='<tr><td colspan="8" style="color:red;text-align:center;">Aucun enregistrement trouvé </td></tr>';
       ...
       while($row=mysqli_fetch_assoc($booking))
       {
         ...
         $roomTable.=' <tr>
               ...
               ';
                          ...
                          <a href="#" class="btn btn-danger btn-sm" onclick="confirm(\'Êtes-vous sûr ? Voulez-vous annuler cette réservation \') && setReject(\''.$row["BookingId"].'\')">Annuler</a>
                              ...
                              <button class="btn btn-secondary btn-sm" onclick="confirm(\'Êtes-vous sûr ? Voulez-vous libérer cette chambre \') && setFree(\''.$row["BookingId"].'\')">Libérer</button>
    ...
    if($noOfType>=1){
        while($row=mysqli_fetch_assoc($allType))
        {
          ...
          $typeTable.=' <tr>
                    ...
                    <img class="round-img" src="../assets/picture/EventType/'.$row["EventImage"].'" alt="Profil"/>
                    </a>
                    </td>
                    <td>'.$row["EventType"].'</td>
                    <td>'.$row["Cost"].'</td>
              ...
              $typeTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous vraiment supprimer ".$row["EventTypeId"]."') && deleteEventType('".$row["EventTypeId"]."')\">Supprimer</button>
        ...
        while($row=mysqli_fetch_assoc($allEvents))
        {
          ...
          $eventTable.=' <tr>
             ...
             ';
              ...
              $eventTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous vraiment supprimer la salle numéro ".$row["EventId"]."') && deleteEvent('".$row["EventId"]."')\">Supprimer</button>
  ...
  echo $eventTable;
   ...
   <thead class="thead-dark">
    <tr >
      ...
      <th scope="col">Type événement</th>
      <th scope="col">N° de salle</th>
   <th scope="col">Date de événement</th>
      <th scope="col">Heure de événement</th>
      <th scope="col">Montant</th>
      <th scope="col">Statut</th>
      <th scope="col">Action</th>
      <th scope="col">Détails</th>
   ...
   switch($filter){
    ...
    case 6:  $selectBooking =  "SELECT em.*,et.EventType,el.HallNumber,us.FirstName FROM event_booking em 
                                ...
                                inner join event_type et on el.EventTypeId = et.EventTypeId 
                                inner join users_details us on us.Userid = em.User_id 
                                where em.Status = 'Payé' And em.Event_date > CURDATE()
                                order by em.Date desc";
                                break;
         ...
         $eventTable.=' <tr>
               ...
               ';
                          ...
                          <a href="#" class="btn btn-danger btn-sm" onclick="confirm(\'Êtes-vous sûr ? Voulez-vous annuler cette réservation \') && setReject(\''.$row["BookingId"].'\')">Annuler</a>
                              ...
                              <button class="btn btn-secondary btn-sm" onclick="confirm(\'Êtes-vous sûr ? Voulez-vous libérer cet événement \') && setFree(\''.$row["BookingId"].'\')">Libérer</button>
...
switch($filter){
 ...
 case 3:  $selectPayments =  "SELECT ep.*,em.*,et.EventType,el.HallNumber,us.FirstName FROM event_payment ep
                              ...
                              inner join event_type et on el.EventTypeId = et.EventTypeId 
                              inner join users_details us on us.Userid = em.User_id 
                              where ep.PaymentType = 'Carte de crédit'
                              order by ep.PaymentDate desc";
                              break;
 ...
 case 4:  $selectPayments =  "SELECT ep.*,em.*,et.EventType,el.HallNumber,us.FirstName FROM event_payment ep
                              ...
                              inner join event_type et on el.EventTypeId = et.EventTypeId 
                              inner join users_details us on us.Userid = em.User_id 
                              where ep.PaymentType = 'Carte de débit'
                              order by ep.PaymentDate desc";
                              break;
 ...
 case 5:  $selectPayments =  "SELECT ep.*,em.*,et.EventType,el.HallNumber,us.FirstName FROM event_payment ep
                              ...
                              inner join event_type et on el.EventTypeId = et.EventTypeId 
                              inner join users_details us on us.Userid = em.User_id 
                              where ep.PaymentType = 'Virement bancaire'
                              order by ep.PaymentDate desc";
                              break;
    ...
    if($noOfUsers>=1){
        while($row=mysqli_fetch_assoc($all))
        {
          ...
          $userTable.=' <tr>
              ...
              $userTable.="<button class='btn btn-danger' name='deleteUser' onclick=\"confirm('Voulez-vous vraiment supprimer le commentaire de ".$row["FirstName"]."') && deleteContact('".$row["ID"]."')\">Supprimer</button>
