...
<section class="chambres">
        <div class="container1">
            <div class="section-header">
                <h2 class="section-title">Appartement d’Hôtes - Ryad Traditionnel</h2>
            ...
            <div class="main-image">
                    ...
                    <div class="thumbnail-grid">
                        ...
                        <div class="thumbnail" style="background-image: url('view1.jpg')"></div>
                    </div>
                </div>
                
                <div class="chambre-content">
                <h3 class="chambre-title">Un cadre enchanteur et apaisant</h3>
                <p>Découvrez l’authenticité et le charme d’un appartement d’hôtes inspiré des plus beaux ryads, où tradition et confort moderne se rencontrent harmonieusement.</p>
               
                <section class="description">
                    <p>Notre appartement offre une expérience unique avec ses mosaïques artisanales, ses luminaires en fer forgé et son mobilier sculpté à la main.</p>
                    <p>Le patio intérieur, agrémenté d’une fontaine en pierre, vous invite à la relaxation dans une ambiance douce et paisible.</p>
                    <p>La terrasse privée vous permet de profiter des nuits étoilées et de la vue panoramique sur les toits de la médina.</p>
                </section>
                
                <section class="features">
                    <h2>Caractéristiques exclusives</h2>
                    <ul>
                        <li><strong>Architecture traditionnelle :</strong> Arches sculptées, zelliges et boiseries raffinées.</li>
                        <li><strong>Chambres élégantes :</strong> Literie haut de gamme et textiles brodés à la main.</li>
                        <li><strong>Salon marocain cosy :</strong> Canapés moelleux et ambiance feutrée.</li>
                        <li><strong>Patio fleuri :</strong> Avec fontaine pour une atmosphère relaxante.</li>
                        <li><strong>Rooftop panoramique :</strong> Pour des moments de détente sous les étoiles.</li>
                        <li><strong>Connexion Wi-Fi rapide :</strong> Pour allier tradition et modernité.</li>
                        <li><strong>Climatisation réversible :</strong> Confort toute l’année.</li>
                    </ul>
                    
                    <h3>✨ Expérience immersive :</h3>
                    <ul>
                        <li>Petit-déjeuner marocain inclus</li>
                        <li>Dîners aux chandelles sur la terrasse</li>
                        <li>Ateliers artisanaux et découvertes culturelles</li>
                        <li>Service de conciergerie personnalisé</li>
                    </ul>
                </section>
